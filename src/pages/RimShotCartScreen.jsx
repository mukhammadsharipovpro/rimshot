...
import RimShotCartItemComponent from '../components/RimShotCartItemComponent';
import RimShotComponent from '../components/RimShotComponent';
        ...
        <>
          <View style={{height: height * 0.7}}>
            <ScrollView style={styles.flex} contentContainerStyle={styles.main}>
              {cart.map((item, index) => (
                <RimShotCartItemComponent item={item} key={index} />
              ))}
            </ScrollView>
          </View>
        </>
