...
import {burgerApp} from '../assets/products';

const RimShotCartItemComponent = ({item}) => {
  ...
  const productImage = burgerApp.find(p => p.name === item.name)?.image;
...
export default RimShotCartItemComponent;
